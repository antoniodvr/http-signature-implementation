...
public class MalformedSignatureClientSigner extends ClientSigner {
    ...
    protected void addSignature(ClientRequestContext requestContext) {
        ...
        requestContext.getHeaders().add(AUTHORIZATION_HEADER_KEY, "malformed" + signer.getAuthorizationHeader("wrong"+signature));
    }
}
